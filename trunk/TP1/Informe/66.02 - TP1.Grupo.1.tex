...
\begin{table}[!hbt]
	\begin{center}
		...
		\begin{tabular}{|c|c|c|c|c|c|c|c|c|c|} \hline
			...
			& \textbf{V} & \textbf{I} & \textbf{R} & \textbf{${\Delta R \over R}$} & \textbf{V} & \textbf{I} & \textbf{R} & \textbf{${\Delta R \over R}$} \\\cline{2-9}
			& V & mA & k$\Omega$ & \% & V & mA & k$\Omega$ & \% \\\cline{2-9}
			& 28.0 & 0.280 & 100 & 8.143 & 2.0 & 0.030 & 67 &  \\\cline{2-9}
			& 29.0 & 0.290 & 100 & 7.897 & 4.0 & 0.062 & 65 &  \\\cline{2-9}
			& 30.0 & 0.300 & 100 & 7.667 & 6.0 & 0.094 & 64 &  \\ \hline
		\end{tabular}
...
\begin{equation}
 	\varepsilon_r(I) = {1.5\%\times I_{medido} + {1 \over 2}\times ??? \over I_{medido}}.  [ TERMINAR ]
\end{equation}
\medskip
