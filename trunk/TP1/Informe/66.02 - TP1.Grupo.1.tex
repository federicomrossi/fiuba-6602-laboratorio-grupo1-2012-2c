...
\begin{equation}
	\varepsilon_r(R) = \textbf{0.089} = \textbf{8.9\%} \\
\end{equation}
\bigskip\bigskip
...
\begin{equation}
	\varepsilon_r(R) = \textbf{0.011} =\textbf{1.1\%} \\
\end{equation}
\bigskip\bigskip
...
\indent Además, hay que señalar la importancia  de tomar en cuenta, al momento de realizar las mediciones, la magnitud de los valores que se van a medir, y decidir si el instrumento elegido es el adecuado, ya que sin esta reflexión previa se puede desembocar en un error mucho mas grande del esperado.  
