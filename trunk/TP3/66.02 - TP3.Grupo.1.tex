...
\section{Incertezas en el osciloscopio}
	...
	La incertezas que se deben considerar son las siguientes:
		Incerteza de lectura: un medio de la mínima división. 
		Exactitud del sistema vertical: 3\%(5mV a 5V/DIV) ; 5\%(1mV a 2mV/DIV)
		Desplazamiento del balance de CC del sistema vertical: ±0,5DIV(5mV a 5V/DIV) ; ±2,0DIV(1mV a 2mV/DIV)
		Linealidad del sistema vertical: ±0,1DIV cuando una señal de amplitud de más de dos divisiones es movida verticalmente.
		Exactitud de la base de tiempo del sistema horizontal: 3\%
		Exactitud de magnificador de barrido del sistema horizontal: ±5\%(1μS a 50mS/DIV) ; ±8\%(1nS a 50nS/DIV)
		Linealidad del sistema horizontal: normal ±3\%(×1) ; magnificado ±5\%(×10)  (±8\% para 10nS a 50nS/DIV)
	La incertezas que se deben considerar son las siguientes:
		Incerteza de lectura: un medio de la mínima división. 
		Exactitud del sistema vertical: 3\%(5mV a 5V/DIV) ; 5\%(1mV a 2mV/DIV)
		Desplazamiento del balance de CC del sistema vertical: ±0,5DIV(5mV a 5V/DIV) ; ±2,0DIV(1mV a 2mV/DIV)
