...
\subsection{Medición de la respuesta en frecuencia}
	...
	Se tomaron las mediciones con la punta atenuada en X1 y se volcaron en el cuadro dela \textit{Tabla 2}.
\bigskip\bigskip
...
\bigskip\bigskip
	...
	Luego se atenuó a  X10  la punta y los controles de V/DIV de los CH 1 y 2 se conmutaron a .2V/DIV. Se varió la frecuencia y se tomaron las mediciones que se encuentran en la \textit{Tabla 3}.
\bigskip\bigskip
