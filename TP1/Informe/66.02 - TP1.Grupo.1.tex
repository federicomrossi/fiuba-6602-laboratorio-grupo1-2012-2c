...
\begin{figure}[h]
	\centering
	\includegraphics[width=0.66\textwidth]{images/item-1.jpg}
...
\begin{figure}[h]
	\centering
	\includegraphics[width=0.94\textwidth]{images/item-2.jpg}
	\caption{Estimación ideal de la caída de tensión entre los bornes A y B \\ de los circuitos (a) y (b).}
\end{figure}
\bigskip
...
\bigskip
	...
	Al reemplazamos el voltímetro analógico por uno digital (en nuestro caso se utilizó un multímetro digital \textit{UNI-T Modelo UT30F}) se obtuvieron los siguientes valores de tensión:
\bigskip
