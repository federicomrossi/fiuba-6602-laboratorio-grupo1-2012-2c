...
\noindent En la \textit{Tabla 2} se pueden observar los valores medidos y calculados para este circuito.
\bigskip
...
\begin{table}[!hbt]
	\begin{center}
		...
		\begin{tabular}{|c|c|c|c|c|c|c|c|c|c|} \hline
			...
			& \textbf{V} & \textbf{I} & \textbf{R} & \textbf{${\Delta R \over R}$} & \textbf{V} & \textbf{I} & \textbf{R} & \textbf{${\Delta R \over R}$} \\\cline{2-9}
			& V & mA & k$\Omega$ & \% & V & mA & k$\Omega$ & \% \\\cline{2-9}
			& 2 & 0.020 & 99.2 &  & 2 & 0.030 & 100 &  \\\cline{2-9}
			& 5 & 0.050 & 99.2 &  & 4 & 0.062 & 100 &  \\\cline{2-9}
			& 8 & 0.080 & 99.2 &  & 6 & 0.094 & 100 &  \\ \hline
		\end{tabular}
...
\begin{table}[!hbt]
	\begin{center}
		...
		\begin{tabular}{|c|c|c|c|c|c|c|c|c|c|} \hline
			...
			& \textbf{V} & \textbf{I} & \textbf{R} & \textbf{${\Delta R \over R}$} & \textbf{V} & \textbf{I} & \textbf{R} & \textbf{${\Delta R \over R}$} \\\cline{2-9}
			& V & mA & k$\Omega$ & \% & V & mA & k$\Omega$ & \% \\\cline{2-9}
			& 2 & 0.020 & 99.2 &  & 2 & 0.020 & 100 &  \\\cline{2-9}
			& 5 & 0.050 & 99.2 &  & 4 & 0.040 & 100 &  \\\cline{2-9}
			& 8 & 0.080 & 99.2 &  & 6 & 0.062 & 100 &  \\ \hline
		\end{tabular}
